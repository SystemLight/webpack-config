...
declare interface AssetInlineGeneratorOptions {
  ...
  dataUrl?:
    ...
    | ((source: string | Buffer, context: {filename: string; module: Module}) => string)
}
...
declare interface AssetParserOptions {
  ...
  dataUrlCondition?:
    ...
    | ((source: string | Buffer, context: {filename: string; module: Module}) => boolean)
}
...
declare class Cache {
  constructor()
  hooks: {
    get: AsyncSeriesBailHook<[string, null | Etag, ((result: any, callback: (arg0?: Error) => void) => void)[]], any>
  ...
  get<T>(identifier: string, etag: null | Etag, callback: CallbackCache<T>): void
...
declare class Chunk {
  ...
  filenameTemplate: null | string | ((arg0: PathData, arg1?: AssetInfo) => string)
  cssFilenameTemplate: null | string | ((arg0: PathData, arg1?: AssetInfo) => string)
  runtime: RuntimeSpec
  files: Set<string>
  ...
  getChildrenOfTypeInOrder(chunkGraph: ChunkGraph, type: string): {onChunks: Chunk[]; chunks: Set<Chunk>}[]
...
type CodeValue =
  ...
  | {
      [index: string]: RecursiveArrayOrRecord<
        undefined | null | string | number | bigint | boolean | Function | RegExp | RuntimeValue
      >
    }
  | RecursiveArrayOrRecord<undefined | null | string | number | bigint | boolean | Function | RegExp | RuntimeValue>[]
...
declare class Compilation {
  ...
  hooks: Readonly<{
    ...
    optimizeChunkModules: AsyncSeriesBailHook<[Iterable<Chunk>, Iterable<Module>], any>
    ...
    runtimeRequirementInChunk: HookMap<SyncBailHook<[Chunk, Set<string>, RuntimeRequirementsContext], any>>
    additionalModuleRuntimeRequirements: SyncHook<[Module, Set<string>, RuntimeRequirementsContext]>
    runtimeRequirementInModule: HookMap<SyncBailHook<[Module, Set<string>, RuntimeRequirementsContext], any>>
    additionalTreeRuntimeRequirements: SyncHook<[Chunk, Set<string>, RuntimeRequirementsContext]>
    runtimeRequirementInTree: HookMap<SyncBailHook<[Chunk, Set<string>, RuntimeRequirementsContext], any>>
    ...
    additionalChunkAssets: FakeHook<Pick<AsyncSeriesHook<[Set<Chunk>]>, 'name' | 'tap' | 'tapAsync' | 'tapPromise'>>
    additionalAssets: FakeHook<Pick<AsyncSeriesHook<[]>, 'name' | 'tap' | 'tapAsync' | 'tapPromise'>>
    optimizeChunkAssets: FakeHook<Pick<AsyncSeriesHook<[Set<Chunk>]>, 'name' | 'tap' | 'tapAsync' | 'tapPromise'>>
    afterOptimizeChunkAssets: FakeHook<Pick<AsyncSeriesHook<[Set<Chunk>]>, 'name' | 'tap' | 'tapAsync' | 'tapPromise'>>
  ...
  getPath(filename: string | ((arg0: PathData, arg1?: AssetInfo) => string), data?: PathData): string
  getPathWithInfo(
    filename: string | ((arg0: PathData, arg1?: AssetInfo) => string),
    data?: PathData
  ): {path: string; info: AssetInfo}
  getAssetPath(filename: string | ((arg0: PathData, arg1?: AssetInfo) => string), data: PathData): string
  ...
  factorizeModule: {
    ...
    (
      ...
      callback: (err?: null | WebpackError, result?: ModuleFactoryResult) => void
    ): void
  }
...
declare class ConcatenationScope {
  ...
  static matchModuleReference(name: string): ModuleReferenceOptions & {index: number}
...
declare interface Configuration {
  ...
  externals?:
    ...
    | ((
        ...
        callback: (err?: Error, result?: string | boolean | string[] | {[index: string]: any}) => void
      ) => void)
...
type ContextMode = 'weak' | 'eager' | 'lazy' | 'lazy-once' | 'sync' | 'async-weak'
declare abstract class ContextModuleFactory extends ModuleFactory {
  hooks: Readonly<{
    ...
    alternatives: FakeHook<Pick<AsyncSeriesWaterfallHook<[any[]]>, 'name' | 'tap' | 'tapAsync' | 'tapPromise'>>
    alternativeRequests: AsyncSeriesWaterfallHook<[any[], ContextModuleOptions]>
  }>
  resolverFactory: ResolverFactory
  resolveDependencies(
    fs: InputFileSystem,
    options: ContextModuleOptions,
    callback: (err?: null | Error, dependencies?: ContextElementDependency[]) => any
  ): void
}
...
declare class DefinePlugin {
  ...
  apply(compiler: Compiler): void
  static runtimeValue(
    fn: (arg0: {module: NormalModule; key: string; readonly version?: string}) => CodeValuePrimitive,
...
declare class Dependency {
  ...
  setLoc(startLine?: any, startColumn?: any, endLine?: any, endColumn?: any): void
  ...
  getCondition(
    moduleGraph: ModuleGraph
  ): null | false | ((arg0: ModuleGraphConnection, arg1: RuntimeSpec) => ConnectionState)
...
declare abstract class ExportInfo {
  ...
  moveTarget(
    moduleGraph: ModuleGraph,
    resolveTargetFilter: (arg0: {module: Module; export?: string[]}) => boolean,
    updateOriginalConnection?: (arg0: {module: Module; export?: string[]}) => ModuleGraphConnection
  ): undefined | {module: Module; export?: string[]}
...
declare abstract class ExportsInfo {
  ...
  restoreProvided(__0: {otherProvided: any; otherCanMangleProvide: any; otherTerminalBinding: any; exports: any}): void
}
...
declare abstract class FileSystemInfo {
  ...
  contextTimestampQueue: AsyncQueue<string, string, null | ContextFileSystemInfoEntry>
  ...
  logStatistics(): void
  clear(): void
  addFileTimestamps(map: ReadonlyMap<string, null | FileSystemInfoEntry | 'ignore'>, immutable?: boolean): void
  addContextTimestamps(map: ReadonlyMap<string, null | FileSystemInfoEntry | 'ignore'>, immutable?: boolean): void
  getFileTimestamp(
    path: string,
    callback: (arg0?: null | WebpackError, arg1?: null | FileSystemInfoEntry | 'ignore') => void
  ): void
  getContextTimestamp(
    path: string,
    callback: (arg0?: null | WebpackError, arg1?: null | 'ignore' | ResolvedContextFileSystemInfoEntry) => void
  ): void
  getFileHash(path: string, callback: (arg0?: null | WebpackError, arg1?: string) => void): void
  getContextHash(path: string, callback: (arg0?: null | WebpackError, arg1?: string) => void): void
  getContextTsh(
    path: string,
    callback: (arg0?: null | WebpackError, arg1?: ResolvedContextTimestampAndHash) => void
  ): void
  resolveBuildDependencies(
    context: string,
    deps: Iterable<string>,
    callback: (arg0?: null | Error, arg1?: ResolveBuildDependenciesResult) => void
  ): void
  ...
  checkSnapshotValid(snapshot: Snapshot, callback: (arg0?: null | WebpackError, arg1?: boolean) => void): void
...
declare class GetChunkFilenameRuntimeModule extends RuntimeModule {
  constructor(
    ...
    name: string,
    global: string,
    getFilenameForChunk: (arg0: Chunk) => string | ((arg0: PathData, arg1?: AssetInfo) => string),
    allChunks: boolean
  )
  contentType: string
  global: string
...
declare class HarmonyImportDependency extends ModuleDependency {
  constructor(request: string, sourceOrder: number, assertions?: Record<string, any>)
  sourceOrder: number
...
declare interface InputFileSystem {
  ...
  readJson?: (arg0: string, arg1: (arg0?: null | Error | NodeJS.ErrnoException, arg1?: any) => void) => void
  readlink: (arg0: string, arg1: (arg0?: null | NodeJS.ErrnoException, arg1?: string | Buffer) => void) => void
  readdir: (
    arg0: string,
    arg1: (arg0?: null | NodeJS.ErrnoException, arg1?: (string | Buffer)[] | IDirent[]) => void
  ) => void
  ...
  realpath?: (arg0: string, arg1: (arg0?: null | NodeJS.ErrnoException, arg1?: string | Buffer) => void) => void
...
declare interface IntermediateFileSystemExtras {
  ...
  open: (arg0: string, arg1: string, arg2: (arg0?: null | NodeJS.ErrnoException, arg1?: number) => void) => void
  read: (
    arg0: number,
    arg1: Buffer,
    arg2: number,
...
declare abstract class ItemCacheFacade {
  ...
  provide<T>(computer: (arg0: CallbackNormalErrorCache<T>) => void, callback: CallbackNormalErrorCache<T>): void
...
declare class JavascriptParser extends Parser {
  ...
  hooks: Readonly<{
    evaluateTypeof: HookMap<SyncBailHook<[UnaryExpression], undefined | null | BasicEvaluatedExpression>>
    evaluate: HookMap<SyncBailHook<[Expression], undefined | null | BasicEvaluatedExpression>>
    ...
    evaluateDefinedIdentifier: HookMap<
      SyncBailHook<[ThisExpression | MemberExpression | Identifier], undefined | null | BasicEvaluatedExpression>
    >
    evaluateNewExpression: HookMap<SyncBailHook<[NewExpression], undefined | null | BasicEvaluatedExpression>>
    evaluateCallExpression: HookMap<SyncBailHook<[CallExpression], undefined | null | BasicEvaluatedExpression>>
    evaluateCallExpressionMember: HookMap<
      SyncBailHook<[CallExpression, undefined | BasicEvaluatedExpression], undefined | null | BasicEvaluatedExpression>
    >
    isPure: HookMap<
      SyncBailHook<
        [
    ...
    classBodyElement: SyncBailHook<
      [MethodDefinition | PropertyDefinition, ClassExpression | ClassDeclaration],
      boolean | void
    >
    classBodyValue: SyncBailHook<
      [Expression, MethodDefinition | PropertyDefinition, ClassExpression | ClassDeclaration],
      boolean | void
    >
    ...
    exportSpecifier: SyncBailHook<
      [ExportNamedDeclaration | ExportAllDeclaration, string, string, undefined | number],
      boolean | void
    >
    exportImportSpecifier: SyncBailHook<
      [ExportNamedDeclaration | ExportAllDeclaration, ImportSource, string, string, undefined | number],
      boolean | void
    >
    ...
    callMemberChain: HookMap<SyncBailHook<[CallExpression, string[], boolean[]], boolean | void>>
    memberChainOfCallMemberChain: HookMap<
      SyncBailHook<[Expression, string[], CallExpression, string[]], boolean | void>
    >
    ...
    expressionMemberChain: HookMap<SyncBailHook<[Expression, string[], boolean[]], boolean | void>>
    unhandledExpressionMemberChain: HookMap<SyncBailHook<[Expression, string[]], boolean | void>>
  ...
  callHooksForExpressionWithFallback<T, R>(
    ...
    fallback: (arg0: string, arg1: string | ScopeInfo | VariableInfo, arg2: () => string[]) => any,
    defined: (arg0: string) => any,
    ...args: AsArray<T>
  ): R
  callHooksForName<T, R>(hookMap: HookMap<SyncBailHook<T, R>>, name: string, ...args: AsArray<T>): R
  callHooksForInfo<T, R>(hookMap: HookMap<SyncBailHook<T, R>>, info: ExportedVariableInfo, ...args: AsArray<T>): R
  ...
  parseCommentOptions(range?: any): {options: null; errors: null} | {options: object; errors: unknown[]}
...
type LoaderDefinition<OptionsType = {}, ContextAdditions = {}> = LoaderDefinitionFunction<
  OptionsType,
  ContextAdditions
> & {
  raw?: false
...
declare interface LoaderPluginLoaderContext {
  ...
  loadModule(
    request: string,
    callback: (err: null | Error, source: string, sourceMap: any, module: NormalModule) => void
  ): void
  importModule(
    request: string,
...
declare abstract class MainTemplate {
  ...
  getAssetPathWithInfo: (path?: any, options?: any) => {path: string; info: AssetInfo}
...
type ModuleFilterItemTypes =
  | string
  | RegExp
  | ((name: string, module: StatsModule, type: 'module' | 'chunk' | 'root-of-chunk' | 'nested') => boolean)
declare class ModuleGraph {
  ...
  getIncomingConnectionsByOriginModule(module: Module): Map<undefined | Module, ReadonlyArray<ModuleGraphConnection>>
...
declare class ModuleGraphConnection {
  constructor(
    ...
    explanation?: string,
    weak?: boolean,
    condition?: false | ((arg0: ModuleGraphConnection, arg1: RuntimeSpec) => ConnectionState)
  )
  originModule: null | Module
...
declare class MultiCompiler {
  ...
  watch(watchOptions: WatchOptions | WatchOptions[], handler: CallbackFunction<MultiStats>): MultiWatching
...
declare class NormalModule extends Module {
  ...
  createSource(context: string, content: string | Buffer, sourceMap?: any, associatedObjectForCache?: Object): Source
...
declare abstract class NormalModuleFactory extends ModuleFactory {
  hooks: Readonly<{
    ...
    createModule: AsyncSeriesBailHook<
      [Partial<NormalModuleCreateData & {settings: ModuleSettings}>, ResolveData],
      void | Module
    >
    module: SyncWaterfallHook<
      [Module, Partial<NormalModuleCreateData & {settings: ModuleSettings}>, ResolveData],
      Module
    >
...
declare class NormalModuleReplacementPlugin {
   ...
   */
  constructor(resourceRegExp: RegExp, newResource: string | ((arg0?: any) => void))
  resourceRegExp: RegExp
...
declare interface Output {
   ...
   */
  assetModuleFilename?: string | ((pathData: PathData, assetInfo?: AssetInfo) => string)
   ...
   */
  cssChunkFilename?: string | ((pathData: PathData, assetInfo?: AssetInfo) => string)

  /**
   * Specifies the filename template of output css files on disk. You must **not** specify an absolute path here, but the path may contain folders separated by '/'! The specified path is joined with the value of the 'output.path' option to determine the location on disk.
   */
  cssFilename?: string | ((pathData: PathData, assetInfo?: AssetInfo) => string)
...
type RawLoaderDefinition<OptionsType = {}, ContextAdditions = {}> = RawLoaderDefinitionFunction<
  OptionsType,
  ContextAdditions
> & {
  raw: true
...
declare abstract class ResolverFactory {
  hooks: Readonly<{
    ...
    resolver: HookMap<SyncHook<[Resolver, UserResolveOptions, ResolveOptionsWithDependencyType]>>
  }>
...
type ServerOptionsHttps = SecureContextOptions & TlsOptions & ServerOptionsImport
...
declare class SideEffectsFlagPlugin {
   ...
   */
  apply(compiler: Compiler): void
  static moduleHasSideEffects(moduleName?: any, flagValue?: any, cache?: any): any
}
...
declare interface SplitChunksOptions {
  ...
  filename: string | ((arg0: PathData, arg1?: AssetInfo) => string)
  automaticNameDelimiter: string
  getCacheGroups: (module: Module, context: CacheGroupsContext) => CacheGroupSource[]
  getName: (module?: Module, chunks?: Chunk[], key?: string) => undefined | string
  usedExports: boolean
...
declare abstract class StatsFactory {
  hooks: Readonly<{
    ...
    filter: HookMap<SyncBailHook<[any, StatsFactoryContext, number, number], any>>
    sort: HookMap<SyncBailHook<[((arg0?: any, arg1?: any) => number)[], StatsFactoryContext], any>>
    filterSorted: HookMap<SyncBailHook<[any, StatsFactoryContext, number, number], any>>
    groupResults: HookMap<SyncBailHook<[GroupConfig[], StatsFactoryContext], any>>
    sortResults: HookMap<SyncBailHook<[((arg0?: any, arg1?: any) => number)[], StatsFactoryContext], any>>
    filterResults: HookMap<SyncBailHook<[any, StatsFactoryContext, number, number], any>>
...
type WarningFilterItemTypes = string | RegExp | ((warning: StatsError, value: string) => boolean)
...
type __TypeWebpackOptions = (data: object) =>
  ...
  | __TypeWebpackOptions
  | RuleSetUseItem[]
declare function exports(options: Configuration, callback?: CallbackWebpack<Stats>): Compiler
...
declare namespace exports {
  ...
  export namespace ModuleFilenameHelpers {
    ...
    export let replaceDuplicates: (array?: any, fn?: any, comparator?: any) => any
  ...
  export namespace config {
    export const getNormalizedWebpackOptions: (config: Configuration) => WebpackOptionsNormalized
    export const applyWebpackOptionsDefaults: (options: WebpackOptionsNormalized) => void
  }
  export namespace dependencies {
    export {ModuleDependency, HarmonyImportDependency, ConstDependency, NullDependency}
  }
  ...
  export namespace javascript {
    export {EnableChunkLoadingPlugin, JavascriptModulesPlugin, JavascriptParser}
  }
  export namespace optimize {
    export namespace InnerGraph {
      ...
      export let onUsage: (state: ParserState, onUsageCallback: (arg0?: boolean | Set<string>) => void) => void
      export let setTopLevelSymbol: (state: ParserState, symbol: TopLevelSymbol) => void
      export let getTopLevelSymbol: (state: ParserState) => void | TopLevelSymbol
      export let tagTopLevelSymbol: (parser: JavascriptParser, name: string) => TopLevelSymbol
  ...
  export namespace web {
    export {FetchCompileAsyncWasmPlugin, FetchCompileWasmPlugin, JsonpChunkLoadingRuntimeModule, JsonpTemplatePlugin}
  }
  export namespace webworker {
    export {WebWorkerTemplatePlugin}
  }
  export namespace node {
    export {NodeEnvironmentPlugin, NodeSourcePlugin, NodeTargetPlugin, NodeTemplatePlugin, ReadFileCompileWasmPlugin}
  }
  ...
  export namespace container {
    export const scope: <T>(scope: string, options: ContainerOptionsFormat<T>) => Record<string, string | string[] | T>
  ...
  export namespace util {
    ...
    export namespace serialization {
      ...
      export const registerLoader: (regExp: RegExp, loader: (arg0: string) => boolean) => void
      ...
      export let createFileSerializer: (fs?: any, hashFunction?: any) => Serializer
